...
package com.marin.catfeina.features.historico.presentation
...
import com.marin.catfeina.core.utils.formatRelativeTime
...
private fun HistoricoItem(
    ...
    Column(
        ...
        Text(
            text = item.tituloDisplay,
            style = MaterialTheme.typography.bodyLarge
        )
        Spacer(modifier = Modifier.height(4.dp))
        Text(
            // Aqui você precisará de uma função utilitária para formatar o tempo
            text = item.dataVisita.formatRelativeTime(),
