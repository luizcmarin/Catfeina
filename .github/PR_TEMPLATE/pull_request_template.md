...
### ✅ Garanta que o código esteja formatado corretamente
...
- [ ] Eu executei `./gradlew :app:assembleDebug` e `./gradlew :app:lintDebug` localmente e o projeto compila sem erros.
